...
describe('CreateSnapshotHoldingDto', () => {
  ...
  it('각 거래소(upbit, bithumb, coinone, binance, bybit, okx, gate, bitget, hyperliquid) 값을 허용해야 한다', async () => {
    const exchanges = ['upbit', 'bithumb', 'coinone', 'binance', 'bybit', 'okx', 'gate', 'bitget', 'hyperliquid'];
